...
const AddProductPage = () => {
  ...
  if (!store.approved) {
    return (
      <main className="mx-auto max-w-3xl px-4 py-8 sm:py-10">
        <h1 className="text-2xl font-bold">Add Product</h1>
        <section className="mt-8 rounded-lg border border-yellow-200 bg-yellow-50 p-6">
          ...
          <button
            type="button"
            onClick={() => navigate("/vendor/store")}
            className="mt-5 rounded-md border border-yellow-300 px-4 py-2.5 text-sm font-medium text-yellow-800 hover:bg-yellow-100"
          >
            View Store
          </button>
        </section>
